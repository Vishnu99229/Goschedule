    ...
    return (
        <footer style={{ borderTop: '1px solid var(--border-subtle)', padding: 'var(--space-6) 0' }}>
            <div className="container flex items-center justify-between" style={{ flexWrap: 'wrap', gap: 'var(--space-3)' }}>
                <Link to="/" style={{ fontSize: 15, fontWeight: 600, color: 'var(--text-secondary)', textDecoration: 'none' }}>
                ...
                <div className="flex gap-5">
                    <Link to="/terms-and-conditions" className="body-sm" style={{ transition: 'color 0.2s' }}
                        onMouseEnter={(e) => (e.currentTarget.style.color = '#fff')}
                        onMouseLeave={(e) => (e.currentTarget.style.color = '')}>
                        Terms &amp; Conditions
                    </Link>
                    <Link to="/privacy-policy" className="body-sm" style={{ transition: 'color 0.2s' }}
                        onMouseEnter={(e) => (e.currentTarget.style.color = '#fff')}
                        onMouseLeave={(e) => (e.currentTarget.style.color = '')}>
                        Privacy Policy
                    </Link>
